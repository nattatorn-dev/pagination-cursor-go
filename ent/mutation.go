...
func (m *UserMutation) SetSalary(f float64) {
	m.salary = &f
	m.addsalary = nil
}

// Salary returns the value of the "salary" field in the mutation.
func (m *UserMutation) Salary() (r float64, exists bool) {
	v := m.salary
	if v == nil {
		return
	}
...
// OldSalary returns the old "salary" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldSalary(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AddSalary(f float64) {
	if m.addsalary != nil {
		*m.addsalary += f
	} else {
		m.addsalary = &f
...
func (m *UserMutation) AddedSalary() (r float64, exists bool) {
	v := m.addsalary
	if v == nil {
		return
	}
...
func (m *UserMutation) ResetSalary() {
	m.salary = nil
	m.addsalary = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.salary != nil {
		fields = append(fields, user.FieldSalary)
	}
	if m.created_at != nil {
